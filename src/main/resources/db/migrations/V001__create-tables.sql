...
(
    ...
    KEY            `idx_game_card_game_id` (`game_id`),
    KEY            `idx_game_card_player_id` (`player_id`),
    CONSTRAINT `fk_game_card_game_id` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`),
    CONSTRAINT `fk_game_card_card_id` FOREIGN KEY (`card_id`) REFERENCES `card` (`id`),
    CONSTRAINT `fk_game_card_player_id` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`) ON DELETE SET NULL
);
